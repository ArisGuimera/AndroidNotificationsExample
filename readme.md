...
Todo el código en la rama [**Master**](https://github.com/ArisGuimera/AndroidNotificationsExample/tree/master)

Las notificaciones en Android te pueden ayudar de muchísimas formas, el problema es que depende de cada versión habrá que hacer una cosa u otra,
es por ello que vamos a hacer una serie de vídeos para DOMINAR las notificaciones de una vez por todas.
